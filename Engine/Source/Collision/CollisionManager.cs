...
public static class CollisionManager {
	...
	public static void DrawColliders(object _, GameTime gameTime) {
		foreach (CollisionCmp cmp in collisionCmps) {
			Collider screenColl = cmp.ScreenCollider;

			// TODO: culling

			Game.SpriteBatch.Draw(cmp.ColliderTex, screenColl.Position, cmp.ColliderTex.Bounds, Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0f);
		}
	}
}
