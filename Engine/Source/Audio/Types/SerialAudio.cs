...
/// <summary>
/// Represents an audio file that can only have one playing instance.
/// This instance, however, can be manipulated live, paused, etc.
/// A typical use case would be background music
/// </summary>
public class SerialAudio : AudioSource, IPausableAudio, ISeekableAudio {
