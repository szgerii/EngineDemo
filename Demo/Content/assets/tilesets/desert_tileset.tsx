...
<tileset version="1.10" tiledversion="1.10.2" name="desert_tileset" tilewidth="32" tileheight="32" tilecount="48" columns="8">
 ...
 <tile id="30">
  <objectgroup draworder="index" id="2">
   <object id="1" x="6.59211" y="9.34868" width="18.2829" height="14.0263"/>
  </objectgroup>
 </tile>
 <tile id="31">
  <objectgroup draworder="index" id="3">
   <object id="5" x="6.17045" y="6.09091" width="18.7045" height="24.1591"/>
  </objectgroup>
 </tile>
 <tile id="37">
  <properties>
 ...
 <wangsets>
  <wangset name="Desert" type="corner" tile="-1">
   ...
   <wangcolor name="Cracked" color="#0000ff" tile="-1" probability="1"/>
   <wangtile tileid="0" wangid="0,0,0,1,0,0,0,0"/>
   <wangtile tileid="1" wangid="0,0,0,1,0,1,0,0"/>
   <wangtile tileid="2" wangid="0,0,0,0,0,1,0,0"/>
   <wangtile tileid="3" wangid="0,3,0,0,0,3,0,3"/>
   <wangtile tileid="4" wangid="0,3,0,3,0,0,0,3"/>
   ...
   <wangtile tileid="11" wangid="0,0,0,3,0,3,0,3"/>
   <wangtile tileid="12" wangid="0,3,0,3,0,3,0,0"/>
   <wangtile tileid="13" wangid="0,3,0,3,0,0,0,0"/>
   <wangtile tileid="14" wangid="0,3,0,3,0,3,0,3"/>
   <wangtile tileid="15" wangid="0,0,0,0,0,3,0,3"/>
   ...
   <wangtile tileid="21" wangid="0,3,0,0,0,0,0,0"/>
   <wangtile tileid="22" wangid="0,3,0,0,0,0,0,3"/>
   <wangtile tileid="23" wangid="0,0,0,0,0,0,0,3"/>
